...
const lineData = [
  { name: '4', votes: 0, confidence: 0 },
  { name: '12', votes: 5, confidence: 2 },
  { name: '21', votes: 12, confidence: 5 },
  { name: '31', votes: 25, confidence: 10 },
  { name: '41', votes: 40, confidence: 15 },
  { name: '51', votes: 60, confidence: 20 },
  { name: '61', votes: 85, confidence: 25 },
  { name: '71', votes: 110, confidence: 30 },
  { name: '81', votes: 135, confidence: 35 },
  { name: '91', votes: 160, confidence: 40 },
  { name: '102', votes: 185, confidence: 45 },
  { name: '114', votes: 210, confidence: 50 },
  { name: '126', votes: 235, confidence: 55 },
  { name: '139', votes: 260, confidence: 60 },
  { name: '151', votes: 285, confidence: 65 },
  { name: '163', votes: 310, confidence: 70 },
  { name: '176', votes: 335, confidence: 75 },
  { name: '189', votes: 360, confidence: 80 },
  { name: '202', votes: 385, confidence: 85 },
  { name: '215', votes: 410, confidence: 90 },
  { name: '228', votes: 435, confidence: 95 },
  { name: '241', votes: 460, confidence: 100 },
  { name: '254', votes: 485, confidence: 105 },
  { name: '268', votes: 510, confidence: 110 },
  { name: '281', votes: 535, confidence: 115 },
  { name: '295', votes: 560, confidence: 120 },
  { name: '310', votes: 585, confidence: 125 },
];
              ...
              <div className="bg-[#0A1025] rounded-[2.5rem] shadow-2xl border border-white/5 overflow-hidden p-8 md:p-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                  <div className="bg-white/5 rounded-2xl p-4 border border-white/5">
                    <p className="text-gray-500 text-[10px] font-bold uppercase tracking-widest mb-2">Validation Score</p>
                    <div className="flex items-baseline space-x-2">
                      <span className="text-2xl font-bold text-white">78</span>
                      <span className="text-teal-400 text-xs font-bold">+12</span>
                    </div>
                  </div>
                  <div className="bg-white/5 rounded-2xl p-4 border border-white/5">
                  ...
                  <div className="bg-white/5 rounded-2xl p-4 border border-white/5">
                    <p className="text-gray-500 text-[10px] font-bold uppercase tracking-widest mb-2">Waitlist</p>
                    <div className="flex items-baseline space-x-2">
