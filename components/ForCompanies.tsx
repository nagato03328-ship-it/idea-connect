        ...
        <div className="text-center mb-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="text-gray-500 uppercase text-xs font-bold tracking-widest">Validated Startups</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-indigo-600 mb-2">$12M+</div>
              <div className="text-gray-500 uppercase text-xs font-bold tracking-widest">Capital Deployed</div>
            </div>
            <div>
